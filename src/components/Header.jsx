...
function Header() {
    ...
    return (
        <header className="header_container">
            <div className={burgerMenuOpen ? "header_burger-menu-page-cover header_burger-menu-page-cover-show" : "header_burger-menu-page-cover header_burger-menu-page-cover-hide"}></div>
            <div className={burgerMenuOpen ? "header_burger-menu-content header_burger-menu-show" : "header_burger-menu-content header_burger-menu-hide"}>
                <CategoryList onClick={closeBurgerMenu} />
            </div>

            <svg onClick={handleClick} className="header_svg burger-menu" width="16" height="15" xmlns="http://www.w3.org/2000/svg"><g fill="#FFF" fillRule="evenodd"><path d="M0 0h16v3H0zM0 6h16v3H0zM0 12h16v3H0z"/></g></svg>
